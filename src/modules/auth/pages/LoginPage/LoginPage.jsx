    ...
    <div ref={formRef} className={styles.content_form}>
      ...
      <div className={styles.div_text}>
        <h1 className={styles.content_text}>
          <span ref={span1Ref} className={styles.x_span}>Sistema de Gestión</span>
          <span ref={span2Ref} className={styles.x_span}>Documental</span>
          <span ref={span3Ref} className={styles.x_span}>"Moche"</span>
        </h1>
      </div>
